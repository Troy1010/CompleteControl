...
Cmd_Execute DisableKey_OriginalExecute = nullptr; //Execute of replaced DisableKey command
Cmd_Execute EnableKey_OriginalExecute = nullptr; //Execute of replaced EnableKey command
